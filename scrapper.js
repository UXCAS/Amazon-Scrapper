...
var request = require('request'),
    ...
    MAX_NO_PAGES = readlineSync.question('How many pages do you want to scrape?\n');
     ...
     STARDATA = readlineSync.question('What kind of star ratings should I look for\n');
              ...
              $('#cm_cr-review_list').children('div').each(function(){
                  ...
                  switch(starRating){
                    case "5.0 out of 5 stars":
                            if(reviewText != ""){
                              fs.appendFile(PRODUCT_NAME+'-5'+'review.txt',reviewText, function (err) {
                                 if (err) throw err;
                             });
                        }
                        break;
                    case "4.0 out of 5 stars":
                            if(reviewText != ""){
                              fs.appendFile(PRODUCT_NAME+'-4'+'review.txt',reviewText, function (err) {
                                 if (err) throw err;
                             });
                        }
                        break;
                    case "3.0 out of 5 stars":
                            if(reviewText != ""){
                              fs.appendFile(PRODUCT_NAME+'-3'+'review.txt',reviewText, function (err) {
                                 if (err) throw err;
                             });
                        }
                        break;
                    case "2.0 out of 5 stars":
                            if(reviewText != ""){
                              fs.appendFile(PRODUCT_NAME+'-2'+'review.txt',reviewText, function (err) {
                                 if (err) throw err;
                             });
                        }
                        break;
                    case "1.0 out of 5 stars":
                            if(reviewText != ""){
                              fs.appendFile(PRODUCT_NAME+'-1'+'review.txt',reviewText, function (err) {
                                 if (err) throw err;
                             });
                        }
                        break;
